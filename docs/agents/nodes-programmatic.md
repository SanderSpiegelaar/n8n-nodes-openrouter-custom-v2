...
Also read `docs/agents/nodes.md` for shared node anatomy and conventions.
...
declarative-style instead (see `docs/agents/nodes-declarative.md`).
...
- Programmatic-style nodes support both **light and full versioning**.
  See `docs/agents/versioning.md` for details.
